    ...
    <div className="w-full">
      ...
      <section className="relative h-[600px] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto space-y-6">
          ...
          <div className="pt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/pendaftaran" className="bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-md font-medium text-lg transition-colors">
              Daftar Sekarang
            </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="w-full md:w-1/2 space-y-6">
              <div className="inline-block bg-green-100 text-green-700 px-4 py-1.5 rounded-full text-sm font-semibold tracking-wide">
                Tentang SMA Kartika
              </div>
              ...
              <div className="pt-4">
                <Link to="/visi-misi" className="inline-flex items-center gap-2 text-green-600 hover:text-green-700 font-semibold text-lg group">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-12">
            ...
            <Link to="/berita" className="hidden md:flex items-center text-green-600 hover:text-green-700 font-medium">
              ...
              <div key={item.id} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow flex flex-col">
                ...
                <div className="p-6 flex-grow flex flex-col">
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-100">
                    <Link to="/berita" className="text-green-600 hover:text-green-700 font-medium text-sm flex items-center gap-1">
                      Baca Selengkapnya
                    </Link>
                  </div>
                </div>
          ...
          <div className="mt-8 text-center md:hidden">
            <Link to="/berita" className="inline-flex items-center text-green-600 hover:text-green-700 font-medium">
      ...
      <section className="py-20 bg-green-600 text-white">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-green-100 mb-8 text-lg">Pendaftaran peserta didik baru tahun ajaran ini telah dibuka. Segera daftarkan diri Anda dan raih masa depan yang lebih baik bersama SMA Kartika.</p>
          <Link to="/pendaftaran" className="inline-block bg-white text-green-600 font-bold px-8 py-4 rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all">
